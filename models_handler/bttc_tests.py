...
from models_handler import fit, predict
...
class TestModelInterface(TestCase):
    ...
    def test_load_model_core(self):
        ...
        self.model.load_model_core(Config.LATEST_TAG)
        self.assertIsInstance(self.model.model_core, GradientBoostingClassifier)
...
class TestApiMethods(TestCase):
    ...
    def test_predict(self):
        ...
        self.assertIsInstance(pred, DataFrame)
